          ...
          <v-form ref="form">
            <v-stepper v-model="e1">
              <v-stepper-header>
                ...
                <v-divider></v-divider>
                <v-stepper-step :complete="e1 > 2" editable step="2" :class="{ 'unclickable': !clickable }"></v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step :complete="e1 > 3" editable step="3" :class="{ 'unclickable': !clickable }"></v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step :complete="e1 > 4" editable step="4" :class="{ 'unclickable': !clickable }"></v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step :complete="e1 > 5" editable step="5" :class="{ 'unclickable': !clickable }"></v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step :complete="e1 > 6" editable step="6" :class="{ 'unclickable': !clickable }"></v-stepper-step>
                <v-divider></v-divider>
                <v-stepper-step :complete="e1 > 7" editable step="7" :class="{ 'unclickable': !clickable }"></v-stepper-step>
                <v-divider></v-divider>
              ...
              <v-stepper-items>
                ...
                <v-stepper-content step="2">
                  <v-card class="mb-5" height="550px">
                    <v-form ref="form2">
                      <v-flex xs12 d-flex>
                        <v-autocomplete sx6 dense v-if="custype === 'indi'" :items="gender" v-model="model.gender" label="Title" required item-text="gender" item-value="abbr" class="input-group--focused" style="margin: 1em" :rules="[(v) => !!v || 'Title is required']"></v-autocomplete>
                      ...
                      <v-flex xs12 d-flex style="height: 60px;">
                        <VuePhoneNumberInput sx6 v-if="custype === 'indi'" dense v-model="model.owner_contact1" label="Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 110px" @update="onUpdate" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.owner_contact2 || 'Phone Number Must be Different From the Already Provided']"/>
                        <VuePhoneNumberInput sx6 v-if="custype === 'indi'" dense v-model="model.owner_contact2" label="Other Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 110px" @update="onUp" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.owner_contact1 || 'Phone Number Must be Different From the Already Provided']"/>
                        <VuePhoneNumberInput sx6 v-if="custype === 'org'" dense v-model="model.company_phone1" label="Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 110px" @update="onUpdate" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.company_phone2 || 'Phone Number Must be Different From the Already Provided']"/>
                        <VuePhoneNumberInput sx6 v-if="custype === 'org'" dense v-model="model.company_phone2" label="Other Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 110px" @update="onUp" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.company_phone1 || 'Phone Number Must be Different From the Already Provided']"/>
                      </v-flex>
                      <v-flex xs12 d-flex>
                        <v-text-field readonly sx6 v-if="custype === 'indi'" dense v-model="model.owner_contact1" label="Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 10px" @update="onUpdate" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.owner_contact2 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                        <v-text-field readonly sx6 v-if="custype === 'indi'" dense v-model="model.owner_contact2" label="Other Phone Number" default-country-code="ZW" valid-color="green" style="margin: 1em; width: 10px" @update="onUp" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.owner_contact1 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                        <v-text-field readonly sx6 v-if="custype === 'org'" dense v-model="model.company_phone1" label="Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 10px" @update="onUpdate" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.company_phone2 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                        <v-text-field readonly sx6 v-if="custype === 'org'" dense v-model="model.company_phone2" label="Other Phone Number" default-country-code="ZW" valid-color="green" style="margin: 1em; width: 10px" @update="onUp" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.company_phone1 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                      </v-flex>
                ...
                <v-stepper-content step="3">
                  <v-card class="mb-5" height="570px">
                    <v-form ref="form3">
                      ...
                      <v-flex xs12 d-flex>
                        <v-text-field sx6 v-if="custype === 'indi'" name="input_1" placeholder="e.g 12-345678-A-90" label="Next of Kin National ID" color="primary" v-model="model.nok_national_id"
                            required id="testing" style="margin: 1em" :rules="[(v) => !!v || 'Next of Kin National ID is required', (v) => /^[0-9]{2}[0-9]{6,7}[a-zA-Z][0-9]{2}$/.test(v) || 'Match Document ID with 12-345678-A-90']" maxlength="15"></v-text-field>
                        <v-text-field sx6 v-if="custype === 'indi'" name="input-1" label="Next of Kin Physical Address" required color="primary" v-model="model.nok_address" style="margin: 1em"
                          :rules="[(v) => !!v || 'Next Of Kin Address is required',]"></v-text-field>
                      ...
                      <v-flex xs12 d-flex style="height: 60px;">
                        <VuePhoneNumberInput sx6 v-if="custype === 'indi'" v-model="model.nok_contact1" label="Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 110px"  @update="onUpdate1" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.nok_contact2 || 'Phone Number Must be Different From the Already Provided']"/>
                        <VuePhoneNumberInput sx6 v-if="custype === 'indi'" v-model="model.nok_contact2" label="Cell Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 110px" @update="onUp1" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.nok_contact1 || 'Phone Number Must be Different From the Already Provided']"/>
                        <VuePhoneNumberInput sx6 v-if="custype === 'org'" v-model="model.rep_contact1" label="Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 110px"  @update="onUpdate1" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.rep_contact2 || 'Phone Number Must be Different From the Already Provided']"/>
                        <VuePhoneNumberInput sx6 v-if="custype === 'org'" v-model="model.rep_contact2" label="Cell Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 110px" @update="onUp1" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.rep_contact1 || 'Phone Number Must be Different From the Already Provided']"/>
                      </v-flex>
                      <v-flex xs12 d-flex>
                        <v-text-field readonly sx6 v-if="custype === 'indi'" dense v-model="model.nok_contact1" label="Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 70px" @update="onUpdate1" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.nok_contact2 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                        <v-text-field readonly sx6 v-if="custype === 'indi'" dense v-model="model.nok_contact2" label="Other Phone Number" default-country-code="ZW" valid-color="green" style="margin: 1em; width: 70px" @update="onUp1" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.nok_contact1 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                ...
                <v-stepper-content step="4">
                  <v-card class="mb-5" height="570px">
                    <v-form ref="form4">
                      <center>
                        <p style="font-family: 'Gill Sans', Arial, Helvetica, sans-serif"><font color="#fc5457"><marquee>Please Tell Us If You Are Employed </marquee></font></p>
                      </center>
                      ...
                      <v-flex xs12 d-flex>
                        <v-text-field sx6 name="input-1" label="Name of Employer" color="primary" v-model="model.name_of_employer" v-if="employed === 'work'" id="testing"
                          style="margin: 1em" :rules="[(v) => !!v || 'Name of Employer is required',]"></v-text-field>
                        <v-text-field sx6 name="input-1" label="Address Of Employer" color="primary" v-model="model.employer_address" v-if="employed === 'work'"
                          id="testing" style="margin: 1em" :rules="[(v) => !!v || 'Employers Address is required',]"></v-text-field>                        
                      </v-flex>
                      <v-flex xs12 d-flex>
                        <VuePhoneNumberInput sx6 v-model="model.employed_contact1" label="Employer Phone" required default-country-code="ZW" valid-color="green" v-if="employed === 'work'" style="margin: 1em; width: 110px" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.employed_contact2 || 'Phone Number Must be Different From the Already Provided']" @update="onUpdate2" maxlength="9"/>
                        <VuePhoneNumberInput sx6 v-model="model.employed_contact2" label="Employer Cell" required default-country-code="ZW" valid-color="green" v-if="employed === 'work'" style="margin: 1em; width: 110px" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.employed_contact1 || 'Phone Number Must be Different From the Already Provided']" @update="onUp2" maxlength="9"/>
                      </v-flex>
                      <v-flex xs12 d-flex>
                        <v-text-field readonly sx6 v-if="employed === 'work'" dense v-model="model.employed_contact1" label="Phone Number" required default-country-code="ZW" valid-color="green" style="margin: 1em; width: 70px" @update="onUpdate2" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.employed_contact2 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                        <v-text-field readonly sx6 v-if="employed === 'work'" dense v-model="model.employed_contact2" label="Other Phone Number" default-country-code="ZW" valid-color="green" style="margin: 1em; width: 70px" @update="onUp2" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.employed_contact1 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                      </v-flex>
                      <v-flex xs12 d-flex>                        
                    ...
                    <v-form ref="form8">
                      <v-card-text>
                        <div ref="printContent" class="print-content">
                          ...
                          <v-form class="form">
                            <div class="form-column">
                              <v-text-field readonly sx6 v-if="custype === 'indi'" dense v-model="model.owner_contact2" label="Other Phone Number" default-country-code="ZW" valid-color="green" style="margin: 1em; width: 70px" @update="onUp" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.owner_contact1 || 'Phone numbers must be different']"></v-text-field>
                              <v-text-field readonly sx6 v-if="custype === 'org'" dense v-model="model.company_phone2" label="Other Phone Number" default-country-code="ZW" valid-color="green" style="margin: 1em; width: 70px" @update="onUp" maxlength="9" :rules="[(v) => (v && v.length === 9) || 'Your Phone Number must be 9 characters long', (v) => !!v || 'Your Phone Number is required', (v) => (v && v.startsWith('7')) || 'Your Phone Number must start with 7', (v) => v !== model.company_phone1 || 'Phone numbers must be different']"></v-text-field>
