                  ...
                  <v-card class="mb-5" height="550px">
                    <v-form ref="form2">
                      ...
                      <v-flex xs12 d-flex>
                        ...
                        <v-text-field sx6 v-if="custype === 'indi'" dense v-model="model.owner_contact2" label="Landline" default-country-code="ZW" valid-color="green" style="margin: 1em; width: 10px" @update="onUp" maxlength="9" :rules="[(v) => !!v || 'Your Phone Number is required', (v) => v !== model.owner_contact1 || 'Phone Number Must be Different From the Already Provided', (v) => v !== model.nok_contact1 || 'Phone Number Must be Different From the Already Provided', (v) => v !== model.nok_contact2 || 'Phone Number Must be Different From the Already Provided', (v) => v !== model.employed_contact1 || 'Phone Number Must be Different From the Already Provided', , (v) => v !== model.employed_contact2 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                        ...
                        <v-text-field sx6 v-if="custype === 'org'" dense v-model="model.company_phone2" label="Landline" default-country-code="ZW" valid-color="green" style="margin: 1em; width: 10px" @update="onUp" maxlength="9" :rules="[(v) => !!v || 'Your Phone Number is required', (v) => v !== model.company_phone1 || 'Phone Number Must be Different From the Already Provided']"></v-text-field>
                      </v-flex>
                      <v-flex xs6 d-flex>
